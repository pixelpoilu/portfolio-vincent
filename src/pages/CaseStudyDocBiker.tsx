...
const eyebrowClassName =
    "text-[0.79rem]  uppercase tracking-[0.32em] text-neutral-650";
...
export default function CaseStudyDocBiker(): ReactElement {
    const stats = [
    ...
    return (
        ...
        >
            ...
            `} id="screen02">
                ...
                <Link
                    to="#screen02"
                    className={`${nextScreenLinkClass} 
                    inset-s-0 
                    top-[calc(100vh-85px)] 
                    2xl:top-[calc(100vh-95px)] 
                    xl:top-[calc(100vh-40px)] 
                    lg:top-[calc(100vh-155px)] 
                    md:top-[calc(100vh-155px)] 
                    sm:top-[calc(100vh-155px)] 
