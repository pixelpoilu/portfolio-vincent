...
const OutlineControlPoint = MdOutlineControlPoint as unknown as ComponentType<{ className?: string }>;

import { IoMdArrowDropright } from "react-icons/io";
const ArrowDropright = IoMdArrowDropright as unknown as ComponentType<{ className?: string }>;
...
const fullScreen =
    "w-full mx-auto min-h-[calc(100svh-var(--navbar-height))] grid place-items-center py-8 relative";
const nextScreenLinkClass =
    "bg-transparent absolute inset-s-0 top-4/5 left-1/2 transform -translate-x-1/2 -translate-y-1/2";
const InsertIcon =
    "inline object-cover";

/* OutlineControlPoint InsertIcon
 rounded-full px-6 py-3 text-white text-lg font-semibold shadow-lg hover:bg-green-700 transition-colors duration-300"
    "bg-green-800 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full px-6 py-3 text-white text-lg font-semibold shadow-lg hover:bg-green-700 transition-colors duration-300";
    ...
    return (
        <div className={simpleSection}>
            <div className={`${shellClassName} grid gap-4 pb-0 md:pb-0`}>
                <motion.div {...reveal} className="grid max-w-1xl gap-4">
                    ...
                    >
                        ...
                        <div className="grid gap-4 md:grid-cols-[minmax(0,1fr)_220px] md:items-end">
                            ...
                            >
                                ...
                                <p className="mt-3 max-w-1xl text-base leading-8 text-neutral-600 md:text-lg">
...
export default function CaseStudyExemple(): ReactElement {
    ...
    const stats = [
        ...
        { label: "Mois de délais", value: 4, unit: " mois", variant: " " },
    ];
    /*
