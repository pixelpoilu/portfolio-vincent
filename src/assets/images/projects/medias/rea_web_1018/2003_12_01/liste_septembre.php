        ...
        <tr> 
          <td><table border="0" cellpadding="5" cellspacing="0">
              <tr class="MoyenText"> 
                ...
                <td class="formula"><strong>Pascale Trichot</strong></td>
                <td class="formula"><strong>(Boissy Saint-L&eacute;ger) </strong></td>
              </tr>
            </table></td>
        </tr>
      </table>
...
<table border="0" cellpadding="5" cellspacing="0">
              <tr> 
                ...
                <td class="MoyenText">Jean-Jacques Laurent</td>
                <td class="formula">(Strasbourg)</td>
                <td rowspan="5" valign="bottom" class="formula"><? echo"$Reponse"; ?></td>
              </tr>
              <tr> 
                <td class="MoyenText">Mme</td>
                <td class="MoyenText">Vanina Durandet</td>
                <td class="formula">(Paris)</td>
              </tr>
              <tr> 
                <td class="MoyenText">M.</td>
                <td class="MoyenText">Dominique Delforge</td>
                <td class="formula">(Mons en Baroeul)</td>
              </tr>
              <tr> 
                <td class="MoyenText">Mme</td>
                <td class="MoyenText">Elodie Coutellier</td>
                <td class="formula">(Paris)</td>
              </tr>
              <tr> 
                <td class="MoyenText">M.</td>
                <td class="MoyenText">Henri-Jacques B&eacute;guin</td>
                <td class="formula">(Fleury-sur-Orne)</td>
              </tr>
            </table>
           </td>
        </tr>
