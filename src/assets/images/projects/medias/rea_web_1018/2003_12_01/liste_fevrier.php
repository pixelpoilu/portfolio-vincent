...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td align="center" valign="top" class="BigTtext"><strong>Liste des gagnants 
      du Jeu de F&eacute;vrier</strong><br>
<br>
      <br>
        ...
        <tr> 
          <td><table border="0" cellpadding="5" cellspacing="0">
              <tr class="MoyenText"> 
                ...
                <td class="formula"><strong>Regis Julie</strong></td>
                <td class="formula"><strong>Saint-Gratien</strong></td>
              </tr>
            </table></td>
        </tr>
      </table>
        ...
        <tr> 
          <td><table border="0" cellpadding="5" cellspacing="0">
              <tr> 
                ...
                <td class="MoyenText"> Karelle Vall&eacute;e</td>
                <td class="formula">(Levallois-Perret)</td>
                <td rowspan="5" valign="bottom" class="formula"><? echo"$Reponse"; ?></td>
              </tr>
              <tr> 
                <td class="MoyenText">M.</td>
                <td class="MoyenText">Philippe Ebran</td>
                <td class="formula">(Marseille)</td>
              </tr>
              <tr> 
                <td class="MoyenText">M.</td>
                <td class="MoyenText">Elisabeth Derderian</td>
                <td class="formula">(Villeurbanne)</td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td class="MoyenText">Mme</td>
                <td class="MoyenText"> Evelyne Juif</td>
                <td class="formula">(Lure)</td>
              </tr>
            </table>
</td>
        </tr>
