        ...
        <tr> 
          <td><table border="0" cellpadding="5" cellspacing="0">
              <tr class="MoyenText"> 
                ...
                <td class="formula"><strong>Isabelle Prawitz</strong></td>
                <td class="formula"><strong>(Yerres) </strong></td>
              </tr>
            </table></td>
        </tr>
      </table>
        ...
        <tr> 
          <td><table border="0" cellpadding="5" cellspacing="0">
              <tr> 
                ...
                <td class="MoyenText">Ga&euml;lle FILLON</td>
                <td class="formula">(Paris)</td>
                <td rowspan="5" valign="bottom" class="formula"><? echo"$Reponse"; ?></td>
              </tr>
              <tr> 
                <td class="MoyenText">Mme</td>
                <td class="MoyenText">Danielle Rolland </td>
                <td class="formula">(St-Germain les A.)</td>
              </tr>
              <tr> 
                <td class="MoyenText">Mme</td>
                <td class="MoyenText">Myra Silva-Labarca</td>
                <td class="formula">(Meaux)</td>
              </tr>
              <tr> 
                <td class="MoyenText">Mme</td>
                <td class="MoyenText">Christelle SIMONIN </td>
                <td class="formula">(Eragny)</td>
              </tr>
              <tr> 
                <td class="MoyenText">Mme</td>
                <td class="MoyenText"> Mich&egrave;le L&eacute;onelli </td>
                <td class="formula">(Martigues)</td>
              </tr>
            </table></td>
        </tr>
      </table></td>
