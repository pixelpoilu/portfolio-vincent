        ...
        <tr> 
          <td><table border="0" cellpadding="5" cellspacing="0">
              <tr class="MoyenText"> 
                ...
                <td class="formula"><strong>Emmanuelle Hugeat</strong></td>
                <td class="formula"><strong>(Besan&ccedil;on) </strong></td>
              </tr>
            </table></td>
        </tr>
      </table>
        ...
        <tr> 
          <td><table border="0" cellpadding="5" cellspacing="0">
              <tr> 
                ...
                <td class="MoyenText"> Yves Beno&icirc;t</td>
                <td class="formula">(Sautron)</td>
                <td rowspan="5" valign="bottom" class="formula"><? echo"$Reponse"; ?></td>
              </tr>
              <tr> 
                <td class="MoyenText">Mme</td>
                <td class="MoyenText">Brigitte Le Penven Duval</td>
                <td class="formula">(Auzeville-Tolosane)</td>
              </tr>
              <tr> 
                <td class="MoyenText">M.</td>
                <td class="MoyenText">Gwenael Nicol</td>
                <td class="formula">(Vannes)</td>
              </tr>
              <tr> 
                <td class="MoyenText">M.</td>
                <td class="MoyenText">Robert Espinasse</td>
                <td class="formula">(Gaillac)</td>
              </tr>
              <tr> 
                <td class="MoyenText">Mme</td>
                <td class="MoyenText"> Marie Lakatos</td>
                <td class="formula">(Cranves-Sales)</td>
              </tr>
            </table>
            </td>
        </tr>
