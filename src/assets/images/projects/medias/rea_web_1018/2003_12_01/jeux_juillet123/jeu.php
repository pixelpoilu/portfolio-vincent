...
<table width="780" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td><table border="0" cellpadding="0" cellspacing="0" bgcolor="#F2F6F0">
        <tr> 
          <td valign="top" class="unnamed1">Comment jouer ?: </td>
          <td rowspan="4" align="right"><img src="couv.gif" width="195" height="219"></td>
        </tr>
        <tr> 
          <td><br> <span class="unnamed2"> Compléter les phrases du paragraphe 
            suivant en choisissant le bon mot dans chaque menu déroulant. Cliquez 
            ensuite sur "valider" pour découvrir l’indice du mois de juillet. 
            </span></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td align="center" valign="middle"><table border="0" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                <td>&nbsp;</td>
                <td><a href="chapitre_mai.html" target="_blank"><img name="journal_mai_egypte_jeu_r8_c6" src="lire_html.gif" width="155" height="16" border="0" alt="Lire le premier chapitre en ligne"></a></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
    ...
    <td bgcolor="F2F6F0"><table width="100%" border="0" cellpadding="6" cellspacing="0" bgcolor="F2F6F0">
        <tr> 
          <td class="unnamed2"><form name="questionnaire" action="">
              ...
              </select>, comme si un coup de vent mena&ccedil;ait d'&eacute;teindre la 
