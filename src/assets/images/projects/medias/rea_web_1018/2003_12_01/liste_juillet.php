  ...
  <tr>
    ...
    <td align="center" valign="top" class="BigTtext"><strong>Liste des gagnants 
        ...
        <tr> 
          <td><table border="0" cellpadding="5" cellspacing="0">
              <tr class="MoyenText"> 
                ...
                <td><strong>Madame Marthe Le Nen, St Barthelemy d'Anjou</strong></td>
              </tr>
            </table></td>
        </tr>
      </table>
      ...
      <table width="500" border="0" cellpadding="1" cellspacing="0">
        ...
        <tr> 
          <td><table width="421" border="0" cellpadding="5" cellspacing="0">
              <tr> 
                <td><img src="img/vide.gif" width="29" height="20"></td>
                <td colspan="3" class="MoyenText">Monsieur Sacha Delbecque, Chamb&eacute;ry<br>
                  Mademoiselle Barbara Rubagotti, Auxerre<br>
                  Monsieur Thomas Humbert, Aytr&eacute;<br>
                  Mademoiselle Valentine Trotter, Marseille<br>
                  Mademoiselle Anne Griffanti Sierentz</td>
