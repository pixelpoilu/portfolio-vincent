...
<table width="779" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      ...
      <td colspan="6" valign="middle" class="moyentext"> Vous avez jusqu'au 31 
        d&eacute;cembre &agrave; minuit pour tenter votre chance et<br>
        participer au grand jeu final des 20 ans de la collection 10/18 &quot;Grands<br>
        d&eacute;tectives&quot;. Pour valider votre inscription, vous devez r&eacute;pondre 
        aux questions suivantes.</td>
    </tr>
    <tr> 
...
<table width="256" border="0" cellpadding="0" cellspacing="0">
  ...
  <input type="hidden" name="id" value="">
    <input type="hidden" name="indice_01" value="<? echo"$reponse01";?>">
