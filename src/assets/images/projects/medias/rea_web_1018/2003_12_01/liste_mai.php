        ...
        <tr> 
          <td><table border="0" cellpadding="5" cellspacing="0">
              <tr class="MoyenText"> 
                ...
                <td class="formula"><strong>Nathalie Tonnoir</strong></td>
        ...
        <tr> 
          <td><table border="0" cellpadding="5" cellspacing="0">
              <tr> 
                ...
                <td class="MoyenText">Roland VanLeeuwen</td>
                <td class="formula">(Paris)</td>
                <td rowspan="5" valign="bottom" class="formula"><? echo"$Reponse"; ?></td>
              </tr>
              <tr> 
                <td class="MoyenText">Melle</td>
                <td class="MoyenText">Jacqueline Flisar</td>
                <td class="formula">(Thiverny)</td>
              </tr>
              <tr> 
                <td class="MoyenText">Mme </td>
                <td class="MoyenText">Mme Fernande Dinaut</td>
                <td class="formula">(Valenciennes)</td>
              </tr>
              <tr> 
                <td class="MoyenText">Melle</td>
                <td class="MoyenText">Marie-Pierre De Martel</td>
                <td class="formula">(Montpellier)</td>
              </tr>
              <tr> 
                <td class="MoyenText">Mme</td>
                <td class="MoyenText">Isabelle Haury</td>
                <td class="formula">(Rennes)</td>
              </tr>
            </table></td>
        </tr>
      </table></td>
